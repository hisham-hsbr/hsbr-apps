...
<head>
    @include('front_end.layouts_copy.head')
</head>
...
<body>
    ...
    <main style="--phoenix-scroll-margin-top: 1.2rem;">
        ...
        @include('front_end.layouts_copy.top-navbar')

        @include('front_end.layouts_copy.top-navbar-search')


        @include('front_end.layouts_copy.home-main-section')


        @include('front_end.layouts_copy.home-section-brand')
